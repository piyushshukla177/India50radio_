    ...
    public void setEmpty() {
        ...
        if (arrayList.size() > 0) {
            ...
            myView.findViewById(R.id.btn_empty_downloads).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(SongByServerPlaylistActivity.this, DownloadActivity.class);
            ...
            myView.findViewById(R.id.btn_empty_music_lib).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent_music_lib = new Intent(SongByServerPlaylistActivity.this, OfflineMusicActivity.class);
