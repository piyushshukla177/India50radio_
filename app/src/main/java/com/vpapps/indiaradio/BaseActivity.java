...
public class BaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageView imageView;
    Button cancelBtn;
    //String httpUrls = "http://penguinradio.dominican.edu/Sound%20FX%20Collection/20th%20Century%20Fox.mp3";
    String httpUrls = "https://india50plusradio.com/secured-access/liveradioapi.php";
...
//                Constant.isScrolled = true;
    ...
    public boolean onPrepareOptionsMenu(final Menu menu) {
        MenuItem settingsMenuItem = menu.findItem(R.id.menu_liveradio_home);
    ...
    void liveRadioDialog(){
        LayoutInflater inflater = LayoutInflater.from(this);
        View view = inflater.inflate(R.layout.layout_liveradio,null);
        imageView = view.findViewById(R.id.ib_mini_playpause);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isPlaying){
                    isPlaying = false;
                    mp.pause();
                    imageView.setImageResource(R.mipmap.ic_play_grey);
                }else {
                    isPlaying = true;
                    mp.start();
                    imageView.setImageResource(R.mipmap.ic_pause_grey);
                }
...
//            seekUpdation();
    ...
    private void openOptionPopUp() {
        ...
        PopupMenu popup = new PopupMenu(ctw, iv_max_option);
