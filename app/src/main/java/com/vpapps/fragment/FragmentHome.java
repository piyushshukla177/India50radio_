...
import com.vpapps.indiaradio.BaseActivity;
...
import com.vpapps.indiaradio.MainActivity;
...
import com.vpapps.indiaradio.SongByCatActivity;
    ...
    private void loadHome() {
        if (methods.isNetworkAvailable()) {
            LoadHome loadHome = new LoadHome(new HomeListener() {
                ...
                @Override
                public void onEnd(String success, String message, ArrayList<ItemHomeBanner> arrayListBanner, ArrayList<ItemAlbums> arrayListAlbums, ArrayList<ItemArtist> arrayListArtist, ArrayList<ItemSong> arrayListSongs) {
                    if (getActivity() != null) {
                        if (success.equals("1")) {
