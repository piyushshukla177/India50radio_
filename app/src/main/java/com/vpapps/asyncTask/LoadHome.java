...
public class LoadHome extends AsyncTask<String, String, String> {
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < jsonArrayBanner.length(); i++) {
                    ...
                    arrayListBanner.add(new ItemHomeBanner(banner_id, banner_title, banner_image, banner_desc, banner_total, null));
                }
    ...
    protected void onPostExecute(String s) {
        homeListener.onEnd(s, message, arrayListBanner, arrayListAlbums, arrayListArtist, arrayListSongs);
